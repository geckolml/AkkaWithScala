...
object ActorCapabilities extends App {
  class SimpleActor extends Actor {
    override def receive: Receive = {
      ...
      case message: String => println(s"[$self] I have receive $message")
  ...
  // b) messages must be SERIALIAZABLE
  // in practice use case clsases and case objects
  ...
  // 2 - actors have information about threir context and about themselves
  ...
  // D -> A -> B
  // forwarding = sending a message wiht the ORIGINAL sender
